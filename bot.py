...
TOKEN = os.environ.get("5618236879:AAH-EJyI1Iwjk-A4JG1gZO88Fs-BvzSB4EU", "")

API_ID = int(os.environ.get("7690644", 12345))

API_HASH = os.environ.get("c14c807a9d9adf3ab146491319d43e17
", "")
app = Client(
        "pdf",
